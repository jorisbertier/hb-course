...
// de pouvoir les lires 
/*
// Cas1 : sélection d'un seul noeud
// let n = document.getElementById("t1");
// console.log(n);
...
// console.log(n);
// console.log(liste[0]);
// console.log(liste[t1]);

//Cas 3 :
// let n = document.querySelector('#t1'); // par id  seulement récupérer 1 balise
// let n = document.querySelector('h1'); // par balise
// let n = document.querySelector('.t1'); // par classe
let n = document.querySelectorAll('h1'); // par balise
...
//
// SELECTIONS DE NOEUDS  VERSION A UTILISER 
// l'objectif est de récupérer un ou plusieurs noeuds en vue
...
console.log(n.className);  //lecture sous forme de chaîne 
...
n.classList.remove("gros"); // suppresion du tableau de classes
n.classList.toggle("gros"); // ajout/suppresion du tableau de classes

n.style.cssText = "color: blue; background-color: yellow;";
